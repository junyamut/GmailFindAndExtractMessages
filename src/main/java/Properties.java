...
public class Properties {
	...
	public static Settings getProperties() throws IOException {
		InputStream inputstream = OAuth2.class.getResourceAsStream(PROPERTIES_FILE_PATH);
		if (inputstream == null) {
			throw new IOException("Properties file not found: " + PROPERTIES_FILE_PATH);
		}
		Gson gson = new GsonBuilder().create();
		Settings properties = gson.fromJson(new InputStreamReader(inputstream, "UTF-8"), Settings.class);
		return properties;
	}
}
